...
from taxsentry.core.evidence_preview import build_evidence_context, build_evidence_preview_text
...
class ControlledWorkflowRegressionTests(unittest.TestCase):
    def test_run_once_processes_three_stubbed_excel_reports(self):
        ...
        def fake_generate(markdown, output_path):
        ...
        workflow.poller.mark_as_processed.assert_called_once_with()
